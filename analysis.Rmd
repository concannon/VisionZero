...
###b:
To begin, I created dummy variables for the time of year, day, and month, as well as borough, contributing factor, and vehicle type.

###c:  
Additional data points might include speed, location, 
